...
BENCHMARK_NAME = 'mobilenetv2_cifar10_oui_timing_profile'
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='MobileNetV2 + CIFAR10 OUI timing profiler.')
...
def main() -> None:
    ...
    payload = build_run_payload(
        kind='cifar10_oui_timing_profile',
