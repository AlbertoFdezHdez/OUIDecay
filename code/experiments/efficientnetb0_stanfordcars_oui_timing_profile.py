...
BENCHMARK_NAME = 'efficientnetb0_stanfordcars_oui_timing_profile'
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='EfficientNet-B0 + Stanford Cars OUI timing profiler.')
...
def main() -> None:
    ...
    data_root, train_set, _, num_classes, downloaded = build_stanfordcars_datasets(
        args.data_root,
        tf_train,
        tf_val,
    ...
    print(f'Run config | epochs={epochs} | train_batches={steps_per_epoch} | wd={args.wd:g} | workers={args.num_workers}')
    ...
    payload = build_run_payload(
        kind='stanfordcars_oui_timing_profile',
